...
namespace OpenQbit_ExternalBank.Web.Presentation.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,Address,Tel,City")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Email,Address,Tel,City")] Employee employee)
        {
            if (ModelState.IsValid)
            {
