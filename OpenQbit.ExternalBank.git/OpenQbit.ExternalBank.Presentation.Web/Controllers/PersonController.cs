...
namespace OpenQbit_ExternalBank.Web.Presentation.Controllers
{
    public class PersonController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,Email,Address,Tel,City")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,Email,Address,Tel,City")] Person person)
        {
            if (ModelState.IsValid)
            {
